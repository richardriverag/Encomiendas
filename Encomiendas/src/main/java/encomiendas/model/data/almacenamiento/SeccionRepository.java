...
public class SeccionRepository implements Repository<Seccion> {
    ...
    public void update(Integer id, Seccion seccion) throws SQLException {
        String SQL_UPDATE = "UPDATE seccion SET  nombre = ?, capacidad = ? WHERE id_seccion = ?";
        ...
        ps.executeUpdate();
            ...
            Logger.getLogger(SeccionRepository.class.getName()).log(Level.SEVERE, "Error al actualizar la sección", e);
